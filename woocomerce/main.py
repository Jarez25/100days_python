...
wcapi = API(
    url="http://tienda.test/",  # Cambia esto a tu URL local de WordPress
    consumer_key="ck_339e7517134d802060c60fbcdb91328e3f79b0cc",
    consumer_secret="cs_897a0c992d24e5823c504b0be5bbbbeec3c2a4a3",
    version="wc/v3"
)
